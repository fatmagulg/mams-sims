...
Jgrid <- list(120,rep(60,2), rep(40,3), rep(30, 4), rep(24,5), rep(20, 6))
...
plot(seq(1,length(Jgrid),1), prob_early, type = 'l', xlab = "Number of stages", ylab = "Probability of early stopping", main = "Probability of early stopping vs number of interims for a fixed sample size")
