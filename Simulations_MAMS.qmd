...
```{r}
# try with my Lan-DeMetz boundaries
LFC <- c(0, 0.545,0.178,0.178, 0.178)
HG <- c(rep(0,5))
Mu <- cbind(HG, LFC)

twostage <- mams_hyp(l = c(0, 2.2457), u = c(3.3446, 2.2457), n = rep(42,2), Mu = Mu)

threestage <- mams_hyp(l = c(0, 0, 2.2637), u = c(4.1708, 2.8458, 2.2637), n = rep(30,3), Mu = Mu)

fourstage <- mams_hyp(l = c(0, 0, 0, 2.2812), u = c(4.8599, 3.3447, 2.6702, 2.2812), n = rep(24,4), Mu = Mu)
...
```{r}
LFC <- c(0, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01)
HG <- c(rep(0,8))
Mu <- cbind(HG, LFC)
n <- c(402,452,1033)
#n = c(261, 253, 220)
...
threestage <- mams_hyp(l = c(0, 0, 2.182), u = c(3.779, 2.672, 2.182), r = 2, sd = 0.33, n = n, Mu = Mu)

results <- threestage$ESS#rbind(twostage$ESS, threestage$ESS, fourstage$ESS)
#rownames(results) <- c("2stage", "3stage", "4stage")
...
LFC <- c(0, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01)
HG <- c(rep(0,8))
alt <- c(0, 0.05, 0.051, 0.05, 0.01, 0.01, 0.01, 0.01)
Mu <- cbind(HG, LFC, alt)
n <- c(402,452,1033)
#n = c(261, 253, 220)

threestage <- mams_hyp(l = c(0, 0, 2.182), u = c(3.779, 2.672, 2.182), r = 2, sd = 0.33, n = n, delta_1 = 0.05, Mu = Mu)

results <- threestage$ESS
#results
