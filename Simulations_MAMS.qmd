...
```{r}
u = c(4.375, 3.094, 2.526, 2.188); l = c(0, 0, 0, 2.1875)
#l = c(0, 0, 2.182); u = c(3.779, 2.672, 2.182)
...
mams_replicates2(l = c(0, 0, 2.1434), u = c(4.5008, 2.8866, 2.1434), mu = c(0,0,0,0), n = c(261, 326, 396), r = 2)$TypeIrate

mams_replicates2(l = c(0, 0, 2.1434), u = c(4.5008, 2.4866, 2.1434), mu = c(0,0.05,0.01,0.01), n = c(rep(315,3)), r = 2)
```
