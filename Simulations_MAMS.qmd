...
```{r}
effects <- seq(0, 0.1, 0.01) #c(0.2,0.3,0.4,0.5)
n <- c(30,30,30)
power_est <- numeric(length = length(effects))
...
mams_replicates2(l = l, u = u, mu = c(0,0.05,0.01,0.01), n = n, sd = 0.3, r = r, nrep = 1000)
```
...
results <- mams_hyp(bounds = 'obf', r = 2, sd = 0.33, n = n, delta_1 = 0.05, Mu = Mu)
