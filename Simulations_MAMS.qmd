...
threestage <- mams_hyp(bounds = 'obf', r = 2, sd = 0.33, n = n, Mu = Mu)
...
LFC <- c(0, 0.05, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01)
HG <- c(rep(0,8))
multiple <- c(0, 0.05, 0.051, 0.05, 0.01, 0.01, 0.01, 0.01)
Mu <- cbind(HG, LFC, multiple)
n <- c(402,452,1033)
#n = c(261, 253, 220)

results <- mams_hyp(l = c(0, 0, 2.182), u = c(3.779, 2.672, 2.182), r = 2, sd = 0.33, n = n, delta_1 = 0.05, Mu = Mu)
