...
```{r}
cat("r = 1:sqrt(7) \n")
pocock <- mams_hyp(bounds = 'pocock', r = 1/sqrt(7), sd = 0.33, n = n, delta_1 = 0.05, delta_0 = 0.02, Mu = Mu)

obf_1 <- mams_hyp(bounds = 'obf_one', r = 1/sqrt(7), sd = 0.33, n = n, delta_1 = 0.05, delta_0 = 0.02, Mu = Mu)

obf_2 <- mams_hyp(bounds = 'obf', r = 1/sqrt(7), sd = 0.33, n = n, delta_1 = 0.05, delta_0 = 0.02, Mu = Mu)
